...
export const workshopChallenges = [
  ...
  },
  {
    ...
    img: listen,
    body:
      "Instead of forming a defense of what another is saying, ask questions to help you understand more thorough what they are saying or meaning.",
  },
  {
    id: 6,
  ...
  },
  {
    ...
    img: justAtouch,
    body:
      "Notice how many times a day you reach out and physically touch as expression of love or appreciation. Make it a point to do this at least 5 times a day.",
  },
  {
    id: 10,
    title: "Self Affirm",
  ...
  },
  {
    ...
    img: smile,
    body:
      "Be intentional about smiling to people around you. Do this to everyone with which work, play or cross paths with. Do this for one day.",
  },
  {
    id: 14,
    title: "Laugh",
    img: laugh,
    body:
      "Find opportunities to have a real belly laugh. Try to have one laugh a day for 5 days. If you laugh so hard you cry, give yourself extra points.",
  },
  {
    id: 15,
  ...
  },
  {
    ...
    body:
      "Say something you like about your family members, friends, or coworkers. Try to share this with at least 5 people over a week.",
  },
  {
    id: 19,
    title: "Just Be There",
  ...
  },
  {
    ...
    img: safe,
    body:
      "Evaluate how secure you are as a friend, family member or coworker. Name three things you know you do to make others feel at ease.",
  },
  {
    id: 23,
    ...
    img: unSafe,
    body:
      "Be honest about your behavior that might cause someone to feel uncomfortable. (i.e. yell, blame, shut down). Commit to end this behavior.",
  },
  {
    id: 24,
    ...
    img: actsOfService,
    body:
      "Create a list of things you don't normally do for others. Try to complete every item once per day for five days.",
  },
  {
    id: 25,
    title: "Be Generous",
    img: beGenerous,
    body:
      "Sacrifice something of value and give it to someone else. Make something in your garage and give it to a friend, give some items from your guarden to someone, scrounge up some old clothes and give them away.",
  },
  {
    id: 26,
    title: "Journal",
  ...
  },
  {
    ...
    img: unplug,
    body:
      "Commit to not using any electronic devices (phone, tablets, etc) for an entire day.",
  },
  {
    id: 32,
  ...
  },
  {
    ...
    body:
      "Identify someone whom you know is holding resentment towards you. Identify the pain you may have caused them (i.e. betrayed, rejected, worthless, etc) and sincerely ask for forgiveness. Don't force this. You're your own person and they're their own person. You're both on different walks of life.",
  },
  {
    id: 36,
    title: "Be More Open***",
    img: moreOpen,
    body:
      "Be more open with someone you know you can trust. Share more about yourself with them.",
  },
  {
    id: 37,
  ...
  },
  {
    ...
    img: badHabbits,
    body:
      "Identify a habit you want to break and give yourself credit for each day you successfully refrain from that behavior.",
  },
  {
    id: 42,
    title: "Trustworthy",
